...
This test suite validates register definitions, CSR mappings, and encoding
helpers used by the RISC-V Advanced Interrupt Architecture (AIA) drivers,
including the APLIC (Advanced Platform-Level Interrupt Controller) and IMSIC
(Incoming Message-Signaled Interrupt Controller). It does not trigger or route
...
helper functions, CSR mappings, and register encoding logic.
...
- Interrupt enable/disable register operations
- SMP hart targeting fields
- Software-triggered MSI injection fields (GENMSI)
