...
def main():
    root = os.environ.get("STEREO_ROOT", ".")
    variant_file = os.environ.get("STEREO_VARIANTS", "stereo_10_variants.txt")
    out_name = os.environ.get("STEREO_RESULTS", "stereo_10_results.tsv")
    rows = []
    ...
    rows.sort(key=lambda r: float(r["gops"]), reverse=True)
