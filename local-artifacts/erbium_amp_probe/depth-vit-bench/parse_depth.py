...
def main():
    root = os.environ.get("DEPTH_ROOT", ".")
    variant_file = os.environ.get("DEPTH_VARIANTS", "depth_10_variants.txt")
    out_name = os.environ.get("DEPTH_RESULTS", "depth_10_results.tsv")
    rows = []
