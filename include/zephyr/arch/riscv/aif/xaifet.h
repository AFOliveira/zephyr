...
/*
 * Canonical NEW instruction words from harness round-trip / job matrix
 * (fixed assembler forms: flq2 ft0,0(a0); packb a0,a1,a2; summit a0,a1,42; …).
 */
#define AIF_NEW_WORD_FLQ2                  0x0005500bU
#define AIF_NEW_WORD_FSQ2                  0x0005502bU
#define AIF_NEW_WORD_FADDI_PI              0x0400802bU
#define AIF_NEW_WORD_FANDI_PI              0x0400902bU
#define AIF_NEW_WORD_FCMOV_PS              0x1c20a02bU
#define AIF_NEW_WORD_FCMOVM_PS             0x0020802bU
#define AIF_NEW_WORD_PACKB                 0x80c5e52bU
#define AIF_NEW_WORD_BITMIXB               0x80c5f52bU
#define AIF_NEW_WORD_AIF_EUROPERISCVSUMMIT 0x02a5c52bU
